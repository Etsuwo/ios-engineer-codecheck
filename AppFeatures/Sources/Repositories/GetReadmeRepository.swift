...
public protocol GetReadmeRepositoryProtocol {
    func getReadme(owner: String, repository: String)
    var readme: AnyPublisher<String, Never> { get }
    var isLoading: AnyPublisher<Bool, Never> { get }
}

public final class GetReadmeRepository: GetReadmeRepositoryProtocol {
    // MARK: Provate
    ...
    public var readme: AnyPublisher<String, Never> {
    ...
    ///   - owner: リポジトリ所有者の名前
    ///   - repository: リポジトリ名
    public func getReadme(owner: String, repository: String) {
