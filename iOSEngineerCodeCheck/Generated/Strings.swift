...
internal enum L10n {
    ...
    internal enum RepositoryDetail {
        internal enum DetailLabel {
            ...
            internal static func text(_ p1: Any, _ p2: Any) -> String {
                L10n.tr("Localizable", "RepositoryDetail.DetailLabel.Text", String(describing: p1), String(describing: p2))
            }
        }
    }
    ...
    internal enum RepositorySearch {
        internal enum DetailLabel {
            /// %@ / ☆ %@
            internal static func text(_ p1: Any, _ p2: Any) -> String {
                L10n.tr("Localizable", "RepositorySearch.DetailLabel.Text", String(describing: p1), String(describing: p2))
            }
        }
        ...
        internal enum OwnerNameLabel {
            ...
            internal static func text(_ p1: Any) -> String {
                L10n.tr("Localizable", "RepositorySearch.OwnerNameLabel.Text", String(describing: p1))
            }
        }
    }
}
